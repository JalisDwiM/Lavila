    ...
    <form role="form" action="/admin/dokter/edit" method="POST" id="formedit">
        {{csrf_field()}}
        ...
        <select class="form-control" name="spesialis" >
                ...
                <option value="Penyakit Dalam" @if($dokter->spesialis == 'Mata') selected @endif>Penyakit Dalam</option>
            </select>
            </div>
        <!-- /.box-body -->
