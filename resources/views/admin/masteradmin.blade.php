...
<!-- Theme style -->
<link rel="stylesheet" href="{{ asset('frontend')}}/dist/AdminLTE.min.css">
<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
    page. However, you can choose any other skin. Make sure you
    apply the skin class to the body tag so the changes take effect. -->
<link rel="stylesheet" href="{{ asset('frontend')}}/dist/css/skins/skin-blue.min.css">
...
<a href="index2.html" class="logo">
    ...
    <span class="logo-lg"><b>Sistem</b>Antrian</span>
</a>
...
<!-- AdminLTE App -->
<script src="{{ asset('frontend')}}/dist/adminlte.min.js"></script>
<script src="{{ asset('frontend')}}/bower_components/moment/min/moment.min.js"></script>


{{-- datepickker --}}
<link rel="stylesheet" href="{{asset('frontend')}}/bootstrap-datepicker/css/bootstrap-datepicker.min.css">
<script src="{{asset('frontend')}}/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
<script src="{{asset('frontend')}}/bootstrap-datepicker/locales/bootstrap-datepicker.id.min.js"></script>
